...
rover_image = "descarga-removebg-preview.png";

rover_x = 10;
rover_y = 10;

function add() {
	background_imgTag = new Image(nasa_mars_images_array); //define una variable con la imagen nueva
	background_imgTag.onload = uploadBackground; // establece la función para cargar esta variable
	background_imgTag.src = "Sin título.png";   
...
function right(){
	...
	{
		rover_x = rover_x + 10;
		consolelog("Cuando se presione la flecha derecha, x -" + rover_x + " | y = "+ rover_y);
		uploadBackground();
		uploadrover();  
	}
}
...
function left(){
	...
	{
		rover_x = rover_x - 10;
		consolelog("Cuando se presione la flecha isquierda, x -" + rover_x + " | y = "+ rover_y);
		uploadBackground();
		uploadrover();  
	}
}
